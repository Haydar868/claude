...
if(widthMenu) setWidthMenu(false)
  ...
  return (
    <div
      className={` ${widthMenu ? 'w-[98%]' : 'w-[140px]'} h-[78px] gap-3 overflow-hidden accardion_trans rounded-[10px] p-1 left-1 bottom-1 bg-[#000000d1] sticky z-10 text-white flex_between`}
    >

...
const Navbar = () => {
  ...
  return (
    <header
      className={`relative ${["/cart", "/auth"].includes(location.pathname) ? "hidden" : ""} `}
    >
      ...
      <div className="flex_between p-2 gap-3">
        ...
        <div className="flex_box gap-1">
          ...
          <button
            ...
            className="w-[72px] h-[34px] border rounded-full"
          >
            Kirish
          </button>
        </div>
      ...
      >
        <div className="flex_box flex-col">
          <img
            className="w-[100px] h-[100px] rounded-full mt-11"
            src="https://img.freepik.com/premium-vector/pizza-logo-design_9845-319.jpg"
            alt="logo"
          />

          <h1 className="akshar text-[25px] font-bold mt-5">PIZZA CENTER</h1>
        </div>
      </Drawer>
      <Contact />
    </header>
